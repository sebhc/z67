...
*		PART67 170
*	2. Loads device DK: instead of SY:
*
*********************************************************************
...
PENTRY	MVI	A,0		Overlay 0
	...
	JC	ERRXIT		exit on error
*
*	Step 1a (new code to check for port number) - GFR
*
*
...
*
	...
	CALL	GETVAL
*
*	OK, have port number, but check with user before proceeding
*
OKTOGO	CALL	$TYPTX
	...
	CALL	$COMP
	JNZ	C.QUIT		no, EXIT immediately
	
	LDA	BASE67
	
	STA	INPORT0		Patch IN/OUT port instructions
	STA	OUPORT0
